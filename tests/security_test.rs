...
use database_replicator::sqlite;
...
fn test_valid_table_names_are_accepted() {
    ...
    for name in valid_names {
        ...
        let validation_result = database_replicator::jsonb::validate_table_name(name);
        assert!(
