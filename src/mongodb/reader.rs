...
///
/// ```no_run
/// # use database_replicator::mongodb::{connect_mongodb, reader::list_collections};
...
///
/// ```no_run
/// # use database_replicator::mongodb::{connect_mongodb, reader::get_collection_count};
...
///
/// ```no_run
/// # use database_replicator::mongodb::{connect_mongodb, reader::read_collection_data};
/// # use database_replicator::jsonb::validate_table_name;
/// # async fn example() -> anyhow::Result<()> {
/// let client = connect_mongodb("mongodb://localhost:27017/mydb").await?;
/// let db = client.database("mydb");
